...
export const ADD_TRIP = gql`
  mutation addTrip($tripName: String!, $tripDetails: String!, $tripDestination: String, $tripCoordinates: [Int], $tripDeparture: String, $tripReturn: String, $tripCompanions: [ID]) {
