...
type Mutation {
  ...
  addTrip(tripName: String!, tripDetails: String!, tripDestination: String, tripCoordinates: [Float], tripCompanions: [ID], tripDeparture: String, tripReturn: String): Trip
